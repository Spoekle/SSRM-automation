...
interface PlaylistFileUploadSectionProps {
  file: File | null;
  setFile: (file: File | null) => void;
}

const PlaylistFileUploadSection: React.FC<PlaylistFileUploadSectionProps> = ({ file, setFile }) => {
  ...
  return (
    <div className="w-full">
      <label className="block mb-1 text-sm text-neutral-700 dark:text-neutral-200">Upload Background Image:</label>
      <div
      ...
      >
        ...
        {file ? (
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-neutral-700 dark:text-neutral-200">Select background image</span>
...
export default PlaylistFileUploadSection;