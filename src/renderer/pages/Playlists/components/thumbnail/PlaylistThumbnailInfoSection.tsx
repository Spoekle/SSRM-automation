...
interface PlaylistThumbnailInfoSectionProps {
  month: string;
  setMonth: (month: string) => void;
}

const PlaylistThumbnailInfoSection: React.FC<PlaylistThumbnailInfoSectionProps> = ({
  month,
  setMonth
}) => {
  const months = [
...
export default PlaylistThumbnailInfoSection;