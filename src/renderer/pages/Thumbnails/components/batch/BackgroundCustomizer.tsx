  ...
  useEffect(() => {
    if (previewRef.current) {
      const updateScale = () => {
        ...
        setPreviewScale({
          x: previewRect.width / 1920,
          y: previewRect.height / 1080
        });
      };
    ...
    <div className="space-y-3">
      ...
      <div className="bg-neutral-100 justify-items-center dark:bg-neutral-600 rounded-lg p-2">
        ...
        >
          ...
          />
            ...
            {/* Month Overlay */}
            {month && (
              <div className="absolute inset-0 -mb-14 flex items-center justify-center pointer-events-none">
                <span className="text-white text-3xl px-2 py-1 rounded shadow-sm">
                  {month}
                </span>
              </div>
            )}
      ...
      <div className="space-y-2">
        ...
        <motion.button
          ...
          className="w-full p-2 bg-yellow-500 hover:bg-yellow-600 text-white text-xs rounded-lg font-medium flex items-center justify-center gap-1"
