    ...
    return (
        <div className="w-full">
            ...
            <div
                ref={containerRef}
                onClick={handleClick}
                className={`relative flex items-center justify-center w-full h-24 border-2 border-dashed rounded-lg cursor-pointer transition-all duration-200 ${isDragging ? 'border-orange-500 bg-orange-500/10 scale-[1.02]' :
